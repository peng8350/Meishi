...
/**
 * Desction:fresco image loader Author:pengjianbo Date:15/12/24 下午9:34
 */
	...
	public void displayImage(Activity activity, String path,
		...
		imageView.setOnImageViewListener(new GFImageView.OnImageViewListener() {
			...
			public void onDraw(Canvas canvas) {
				Drawable drawable = draweeHolder.getHierarchy()
						.getTopLevelDrawable();
				if (drawable == null) {
		...
		Uri uri = new Uri.Builder().scheme(UriUtil.LOCAL_FILE_SCHEME).path(path)
				.build();
