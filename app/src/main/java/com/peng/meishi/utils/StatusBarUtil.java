...
import com.peng.meishi.widget.StatusBarView;
...
public class StatusBarUtil {
	...
	public static void setColor(Activity activity, @ColorInt int color,
		...
		if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
			...
			if (count > 0 && decorView
					.getChildAt(count - 1) instanceof StatusBarView) {
	 ...
	 *            状态栏颜色值
	 */
	public static void setColorNoTranslucent(Activity activity,
			@ColorInt int color) {
	...
	public static void setTranslucentForImageViewInFragment(Activity activity,
			View needOffsetView) {
		setTranslucentForImageViewInFragment(activity, DEFAULT_STATUS_BAR_ALPHA,
				needOffsetView);
	}
