        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if (mInnerScrollView instanceof ScrollView) {
                    ...
                    View c = lv.getChildAt(lv.getRefreshableView().getFirstVisiblePosition());
                ...
                if (Math.abs(dy) > mTouchSlop) {
                    ...
                    if (mInnerScrollView instanceof ScrollView) {
                        ...
                        if (!isTopHidden
                            ...
                            if (((HeaderViewListAdapter) lv.getRefreshableView().getAdapter()).getWrappedAdapter() != null && ((HeaderViewListAdapter) lv.getRefreshableView().getAdapter()).getWrappedAdapter().getCount() == 0) {//当ListView或ScrollView 没有数据为空时
                                initVelocityTrackerIfNotExists();
                                mVelocityTracker.addMovement(ev);
                                mLastY = y;
                                return true;
